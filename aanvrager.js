...
function Aanvrager(kenmerken) {
  ...
  this.huurtoeslag = function() {
    return huurToeslagA() + huurToeslagB() + huurToeslagC();
  };
  ...
  function huurToeslagB() {
    ...
    if (that.rekenhuur < 374.44) { return 0; }
    var toeslag = Math.min(that.rekenhuur(), that.aftoppingsgrens()) - Math.max(that.basishuur(), that.maximaleHuurgrens());
...
Aanvrager.prototype.soortHuishouden = function() {
  ...
  if (this.hoofdaandeelAOWers) { huishouden += " 65+"; }
  return huishouden;
};
